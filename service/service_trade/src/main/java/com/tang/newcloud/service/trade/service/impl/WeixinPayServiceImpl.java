...
//            return sendPayQuestion(orderNo, remoteAddr, order);
            //组装需要的内容
            Map<String, Object> map = new HashMap<>();
            map.put("result_code", "20000");//响应码
            map.put("code_url", "https://100.116.29.76/pay/04D1615946E292201CB09D07AC50B71B.jpg");//生成二维码的url
            ...
            throw new NewCloudException(ResultCodeEnum.PAY_UNIFIEDORDER_ERROR);
        }
    }

    // Native下单API
    private Map<String, Object> sendPayQuestion(String orderNo, String remoteAddr, Order order) throws Exception {
        //调用微信api接口：统一下单（支付订单）
